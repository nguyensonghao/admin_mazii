...
<form action="{{  Asset('edit-javi') }}" method="POST">
	<legend>Chỉnh sửa Javi</legend>
	...
	<div class="form-group">
		...
		<textarea name="phonetic" class="form-control not-json" rows="3">
	...
	<div class="form-group">
		<label>Mean:</label>
		<textarea name="mean" class="form-control" rows="10" required="required">
			{{ ($wordDatabase->mean) }}
		</textarea>
	</div>
